...
import {withStyles, WithStyles, Button, Card, CardContent, Divider, TextField, Typography, createStyles} from '@material-ui/core';
...
interface IComingSoonPage extends WithStyles<typeof styles> {}

class ComingSoonPage extends Component<IComingSoonPage> {
