...
import {withStyles, WithStyles, createStyles, Card, CardContent, Grow, Typography} from '@material-ui/core';
...
interface IMaintenancePage extends WithStyles<typeof styles> {} 

const MaintenancePage: React.FunctionComponent<IMaintenancePage> = (props) => {
    const {classes} = props;
