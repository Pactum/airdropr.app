...
import {withStyles, WithStyles, Button, Card, CardContent, Typography, createStyles} from '@material-ui/core';
...
const styles = (theme: Theme) => createStyles({
    ...
    price : {
        backgroundColor: theme.palette.primary.main, // theme.palette.primary[600],
        color          : theme.palette.secondary.main // (theme.palette.primary[600])
    }
});

interface IPricingPage extends WithStyles<typeof styles> {}

const PricingStyle3Page:React.FunctionComponent<IPricingPage> = (props) => {
    const {classes} = props;
