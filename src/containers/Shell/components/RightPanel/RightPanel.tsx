...
import {withStyles, WithStyles, createStyles, Divider, Drawer, Icon, List, ListItem, ListItemIcon, 
    ListItemSecondaryAction, ListItemText, ListSubheader, Switch, Typography} from '@material-ui/core';
...
interface IRightPanel extends WithStyles<typeof styles> {
    getQuickPanelData: any;
    state: any;
    toggleQuickPanel: any;
    data: any;
} 

class RightPanel extends Component<IRightPanel> {
...
export default withReducer('quickPanel', reducer)(withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(RightPanel)));
